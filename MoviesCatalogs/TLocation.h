 ...
 * ********************************************************************************/
#ifndef __T_LOCATION_H__
#define __T_LOCATION_H__
#pragma once
...
// name of Table
#define t3Location			wxT("tblLocation")
// Required Field-definitions
#define t3Location_NAME		wxT("Location")


class TLocation : public lkSQL3TableSet
{
public:
	TLocation();
	TLocation(lkSQL3Database* pDB);
...
public:
	...
	void						SetLocationValue(const wxString&); // NULL not allowed
...
public:
	...
	static bool					IsUniqueLocation(lkSQL3Database* _DB, const wxString& genre, void*); // TRUE if given location-name doesn't exist in table
...
private:
	wxDECLARE_DYNAMIC_CLASS_NO_COPY(TLocation);
};

#endif // !__T_LOCATION_H__

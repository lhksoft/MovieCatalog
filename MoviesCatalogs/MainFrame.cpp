...
void MainFrame::OnAbout(wxCommandEvent& WXUNUSED(event))
{
	...
	info.SetVersion("3.0.0.0", "3.0.0.0 product version 7.0.0.0");
	info.SetDescription("Movies Catalog Program using wxWidgets and SQLite3");
	info.SetCopyright("CopyLeft � 2015-'16,2019,2021-'22 by LhK-Soft, Laurens H. Koehoorn");
